...
/**
 * Function to check is Neighbor Solicitation packet is used for DAD
 *
 */
public class isDadNS extends Function
{
	...
	public void evaluate(Object[] arg0, Object[] arg1, Context arg2, EventTracker arg3) {
		...
		try
		{
			...
			if (packet.hasHeader(ns) && packet.hasHeader(ip6))
		    {
		    	if(InetAddress.getByAddress(ip6.source()).getHostAddress().toString().equals("0:0:0:0:0:0:0:0")  && 
		    			InetAddress.getByAddress(ip6.destination()).getHostAddress().toUpperCase().startsWith("FF02:0:0:0:0:1:FF"))
		    	{
		    		arg1[0] = true;
		    	}
		    	else
